...
static constexpr auto qt_meta_stringdata_ZN10HttpServerE = QtMocHelpers::stringData(
    "HttpServer"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10HttpServerE[] = {
...
Q_CONSTINIT const QMetaObject HttpServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10HttpServerE.offsetsAndSizes,
    qt_meta_data_ZN10HttpServerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10HttpServerE_t,
        // Q_OBJECT / Q_GADGET
...
void *HttpServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10HttpServerE.stringdata0))
